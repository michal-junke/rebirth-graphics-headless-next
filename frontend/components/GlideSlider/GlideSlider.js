          ...
          <div className="overflow-hidden w-full">
            <div id="slider" className={`glide-${instance} ${className} relative`}>
              <div className="absolute w-full h-full" data-glide-el="controls">
                <button type="button" className={`${buttons ? 'md:absolute' : ''} hidden right-0 inset-y-0 z-10 pr-6 text-white`} data-glide-dir=">">
                ...
                <button type="button" className={`${buttons ? 'md:absolute' : ''} hidden left-0 inset-y-0 z-10 pl-6 text-white`} data-glide-dir="<">
                  <svg width="61" height="61" viewBox="0 0 61 61" fill="none" xmlns="http://www.w3.org/2000/svg">
